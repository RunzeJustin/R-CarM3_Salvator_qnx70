...
#define HDMI0_REG_BASE 	0xFEAD0000
#define HDMI1_REG_BASE 	0xFEAE0000
#define HDMI_REG_SIZE 	0x10000
...
#define HDMI_FC_RDRB8                           0x10C0
#define HDMI_FC_RDRB9                           0x10C1
...
struct dw_hdmi_multi_div {
        ...
        unsigned short multi[DW_HDMI_RES_MAX];
};
...
struct dw_hdmi_curr_ctrl {
        uint32_t mpixelclock;
        unsigned short curr[DW_HDMI_RES_MAX];
};

struct dw_hdmi_phy_config {
        uint32_t mpixelclock;
        unsigned short sym_ctr;    /*clock symbol and transmitter control*/
        unsigned short term;       /*transmission termination value*/
        unsigned short vlev_ctr;   /* voltage level control */
};

struct hdmi_vmode {
        int mdataenablepolarity;
...
struct dw_hdmi {
	unsigned int hdmi_phy_base;
	uintptr_t regs;
	void *port;
	struct hdmi_data_info hdmi_data;
	int vic;

	unsigned char edid[HDMI_EDID_LEN];
	int cable_plugin;
	...
	int disabled;                  /* DRM has disabled our bridge */
