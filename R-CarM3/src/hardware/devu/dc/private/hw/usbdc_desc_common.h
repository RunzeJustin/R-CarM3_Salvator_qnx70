/*
 * $QNXtpLicenseC:
 * Copyright 2006, QNX Software Systems.
 *
...
// bMaxPower defaults: 900 mA can be drawn when configured, but divide by 8 for reporting as specified in usb3 spec chapter 9
#ifndef USBDC_MAX_CURRENT_SS
#define USBDC_MAX_CURRENT_SS          ( 900/8 )
#endif
...
const char usbdc_bos_descriptor[] = {
	 ...
	 * TODO: make this configurable on a per platform basis via a commandline option to the driver
	 * or something*/
	0x4,								/* bU1DevExitLat			*/
	0x57,								/* wU2DevExitLat			*/
	0x00,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/beta/hardware/devu/dc/private/hw/usbdc_desc_common.h $ $Rev: 763531 $")
#endif
