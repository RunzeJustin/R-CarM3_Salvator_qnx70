#ifndef _CAP_AF_PRIV_H_
#define _CAP_AF_PRIV_H_
/*
 * $QNXLicenseC:
...
#endif	/* _CAP_AF_PRIV_H_ */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/beta/services/pci/modules/capabilities/private/cap_af_priv.h $ $Rev: 798837 $")
#endif
